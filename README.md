...
| v0.4 | 线程池 | 🚧 计划中 | 任务队列 + worker 线程 + 异步回调 |
...
| 文档 | 内容 |
|------|------|
| [序列化层设计文档](docs/01-serialization-layer.md) | TLV 编码原理、字节序处理、接口设计 |
| [协议帧层设计文档](docs/02-protocol-frame-layer.md) | 帧格式设计、粘包/拆包处理、状态机 |
| [网络 IO 层设计文档](docs/03-epoll-network-io.md) | epoll 原理、ET/LT、Reactor 模式 |
